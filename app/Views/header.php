        ...
        <div class="container"><a href="#" class="navbar-brand text-uppercase font-weight-bold"></a>
            ...
            <div id="navbarSupportedContent" class="collapse navbar-collapse">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item"><a href="#" class="nav-link text-uppercase font-weight-bold">Browse</a></li>
                    <li class="nav-item"><a href="#" class="nav-link text-uppercase font-weight-bold">Download</a></li>
                </ul>
            </div>
        </div>
    </nav>
